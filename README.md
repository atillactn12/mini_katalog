# 🌸 Mini Katalog Uygulaması: Destegül Çiçekçilik
...
**Temel Özellikler:**
* GridView ile şık ürün listeleme ve arama/filtreleme özelliği.
* Detaylı ürün inceleme sayfası ve dinamik Route argument aktarımı.
* State yönetimi ile çalışan temel sepet simülasyonu.
...
3. Bir emülatör veya fiziksel cihaz bağlayarak uygulamayı başlatın:
